...
<body>
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm">
                ...
                <button type="button" class="btn btn-lg btn-secondary disabled mt-2 w-100" onclick="window.location.href='poster_postings.php'">My Postings</button>
                <hr>
                                ...
                                while($row = $stmt->fetch()){
                                    ...
                                    <div class="card mb-3 mt-3" style="max-width: 900px; margin:auto">
                                        <div class="row g-0">
                                            ...
                                            <?php echo "<img style = 'height:100x' class='img-fluid rounded-start'src='uploadImage/". $image."'>"; ?>
    ...
    <script>
        ...
        function update_job(id){
                ...
                window.location.href='poster_update_job.php?id='+id;
            
        }
        function view(id){
            
            window.location.href='poster_view_applications.php?id='+id;
