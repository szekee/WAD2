    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm">
                ...
                <button type="button" class="btn btn-lg btn-secondary disabled mt-2 w-100" onclick="window.location.href='seeker_liked.php'">Liked Jobs</button>
            ...
            <div class="col-sm-10">
                <h1 class='display-4 text-center fw-light'>My Liked Jobs</h1>
                    <?php
                        // connect to database
                        ...
                        // SQL statement
                        $sql = "select job.jobid,job.jobname,job.rolerequired,job.jobdesc,job.picturepath,job.skills,job.startdate,job.enddate,job.address,job.createdate,job.listingstatus,applylisting.applydate,applylisting.applicationstatus,likelisting.is_liked from job inner join likelisting on likelisting.jobid=job.jobid and likelisting.userid=:userid left join applylisting on applylisting.jobid=likelisting.jobid and applylisting.userid=:userid";
                        ...
                        $stmt->setFetchMode(PDO::FETCH_ASSOC);
                                while($row = $stmt->fetch()){
                                    ...
                                    <div class="card mb-3 mt-3 lh-tight active" style="max-width: 900px; margin:auto"  id="<?php echo $id?>" onclick="getDetails(this.id)">
                                        <div class="row g-0">
                                            <div class="col-md-3">
                                            <?php echo "<img class='img-fluid rounded-start' style='width:100%,height:auto,object-fit: cover' src='uploadImage/". $image."'>"; ?>
    ...
    <script>
        ...
        function Buttontoggle(id){
            ...
            if(t.innerHTML=="♥ Like"){
                ...
                window.location.href="add_like.php?backto=seeker_liked.php&id="+id;
                ...
                window.location.href="delete_like.php?backto=seeker_liked.php&id="+id;
                }
            }
        ...
        function confirmapply(id) {
            ...
            if (r == true) {
                window.location.href="apply_job.php?backto=seeker_liked.php&id="+id;
            }}
