    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md" style="border-right: 1px solid black">
                ...
                <button type="button" class="btn btn-lg btn-outline-secondary  mt-2 w-100" onclick="window.location.href='view_job.php'">Back to Posting</button>
                <hr>
            ...
            <div class="col-md-10">
                ...
                <form action='' method='post'>
                    ...
                    if (isset($_POST["Submit"])){
                        ...
                        if ($stmt->execute()){
                            // header('Location: view_job.php?update=successful');
                            echo("<script>location.href = 'view_job.php?update=successful';</script>");
                        }
                        else{
                            // header('Location: view_job.php?update=unsuccessful');
                            echo("<script>location.href = 'view_job.php?update=unsuccessful';</script>");
