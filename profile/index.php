...
<div id="app">
    <main class="w-75 m-auto">
        ...
        <div class="row p-5 rounded-3 bg-dark" >
            <div class="col">
                <img :src="profilepic" class="avatar rounded-circle mb-4">
            </div>
        ...
        <div class="row my-3">
            <div v-if="portfoliopath1 != ''" id="bio-imgs" class="col">
                <h3>Photo Gallery</h3>
                <img v-if="portfoliopath == []" :src="portfoliopath1">
                <carousel v-else :portfoliopath="portfoliopath" :portfoliopath1="portfoliopath1"></carousel>
            </div>
        </div> 
