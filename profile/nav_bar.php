...
if (isset($_SESSION['userid'])) {
    ...
    if ($profile != null) {
        ...
        $profilepic = $profile->getProfilepic(). "?t=" . time();    
        $profilepicstyle = "";
        $viewbutton = ""; 
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navbarScroll">
                <ul class="navbar-nav me-0 my-2 my-lg-0 navbar-nav-scroll" style="--bs-scroll-height: 300px;">
                    ...
                    <li class="nav-item dropdown px-3">
                        <a class="nav-link active dropdown-toggle text-light" href="#" id="navbarScrollingDropdown" role="button"
                                    ...
                                    <div class="card m-3">
                                        ...
                                        <div class="row mb-3">
                                            <div class="col d-flex my-2 justify-content-center">
                                                <a class="btn btn-secondary fs-6 <?=$viewbutton;?>" href="index.php" role="button"
                                                    style="width:100px;">View</a>
                                            </div>
                                            <div class="col d-flex my-2 justify-content-center">
                                                <a class="btn btn-secondary fs-6" href="createProfile.php" role="button"
